        ...
        try
        {
            using (MemoryStream memoryStream = new MemoryStream())
            {
                using (ExcelPackage package = new ExcelPackage(memoryStream))
                {
                    ...
                    worksheet.Cells["A12"].Value = "N° de remisión:";
                    worksheet.Cells["B12"].Value = pedidoOpe.Pedido.NumeroRemision;

                    worksheet.Cells["A14"].Value = "Operador logístico:";
                    worksheet.Cells["B14"].Value = pedidoOpe.Pedido.OperadorLogistico;

                    worksheet.Cells["A16"].Value = "Correo operador logístico:";
                    worksheet.Cells["B16"].Value = pedidoOpe.Pedido.CorreoCliente;

                    worksheet.Cells["A18"].Value = "Observación operador logístico:";
                    worksheet.Cells["B18"].Value = pedidoOpe.Pedido.ObservacionOperador;

                    int rowStart = 20;

                    worksheet.Cells[rowStart, 1].Value = "Paciente";
                    worksheet.Cells[rowStart, 2].Value = "TipoMuestra";
                    worksheet.Cells[rowStart, 3].Value = "Muestra";
                    worksheet.Cells[rowStart, 4].Value = "Fecha";
                    worksheet.Cells[rowStart, 5].Value = "Identificación";
                    worksheet.Cells[rowStart, 6].Value = "Retirada";
                    worksheet.Cells[rowStart, 7].Value = "Rechazada";
                    worksheet.Cells[rowStart, 8].Value = "ObservacionOperador";
                    worksheet.Cells[rowStart, 9].Value = "EstadoMuestra";

                    int row = rowStart + 1;
                    foreach (var pedidos in pedidoOpe.Muestras)
                    {
                        worksheet.Cells[row, 1].Value = pedidos.Paciente;
                        worksheet.Cells[row, 2].Value = pedidos.TipoMuestra;
                        worksheet.Cells[row, 3].Value = pedidos.CodigoBarra;
                        worksheet.Cells[row, 4].Value = pedidos.FechaOrden.ToString("yyyy-MM-dd");
                        worksheet.Cells[row, 5].Value = pedidos.Identificacion;
                        ...
                        worksheet.Cells[row, 8].Value = pedidos.ObservacionOperador;
                        worksheet.Cells[row, 9].Value = pedidos.EstadoMuestra;
                        row++;
                    }
