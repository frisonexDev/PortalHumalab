    ...
    public class ClienteController : Controller
    {
		...
		public async Task<int> EnviarCorreoPedido(Pedido Valor, string idenCliente)
        {
            ...
            try
            {
                ...
                UsuarioGalileoResponse listaOperadores = new UsuarioGalileoResponse();
                UsuarioGalileoResponse listaCliente = new UsuarioGalileoResponse();
                ...
                pedidoCorreo.correoOperador = listaOperadores.correo!;
                pedidoCorreo.correoCliente = listaCliente.correo!;

                //foreach (var operador in listaOperadores)
                //{
                //    if (Valor.IdOperador == Convert.ToInt32(operador.identificacion))
                //    {
                //        pedidoCorreo.correoOperador = operador.correo;
                //    }
                //}
                                                      ...
                                                      string idenCliente)
        {
            ...
            try
            {
                ...
                elimPedido.correoOperador = listaOperadores.correo!;
                elimPedido.correoCliente = listaCliente.correo!;

    //            foreach (var operador in listaOperadores)
    //            {
    //                if (idOPerador == Convert.ToInt32(operador.identificacion))
    //                {
    //                    elimPedido.correoOperador = operador.correo;
    //                }
    //            }
